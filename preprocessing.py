...
# Mean test score: -0.11613219141241714
# Mean train score: -0.11368615726573987
# Best: -0.102007 using {'dense_layer_sizes': (30,), 'epochs': 25, 'optimizer': 'RMSprop'}
...
def build_model():
    model = models.Sequential()
    model.add(layers.Dense(30, activation='sigmoid', input_shape=(scaler_X_train.shape[1],)))
